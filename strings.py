...
db_missing = "No database file found at {f}. Either edit the config (usually /etc/environd/config.py) to point to a database file, or `touch {f}` to create one."
...
reduce_of_emptyset = "Failed to average emptyset. Returning all recent data until the database has more then `present_recent_reduce_to` entries."